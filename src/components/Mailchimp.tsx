...
import { Button, Flex, Heading, Input, Text, Background, Column } from "@/codemindz/components";
import { opacity, SpacingToken } from "@/codemindz/types";
import { useState } from "react";
import { useToast } from "@/codemindz/components/ToastProvider";
...
export const Mailchimp = ({ newsletter }: { newsletter: NewsletterProps }) => {
  ...
  const contact_form = async (e :any) => {
    e.preventDefault();
