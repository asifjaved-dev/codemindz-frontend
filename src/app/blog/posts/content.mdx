---
title: "Codemindz"
summary: "Codemindz Portfolio."
publishedAt: "2025-05-11"
tag: "Codemindz Portfolio"
---

## Avatar

Replace the `public/images/logo/avatar.jpg` file with your own avatar image. It is used on the `/about` page as well as on the dynamically generated `open-graph` images.
...
<CodeBlock
  ...
  {
    code:
`import { InlineCode } from "@/codemindz/components";
...
`const social = [
    ...
    },
    {
      name: "Email",
      icon: "email",
      link: "mailto:asifjaveddev@gmail.com",
    },
];`,
    language: "tsx",
    label: "src/app/resources/content.js"
...
`const home = {
    label: "Home",
    title: "Codemindz Portfolio",
    description: "Portfolio website showcasing my work",
    headline: <>software Engineer and builder</>,
    subline: (
      <>
        I'm Asif Javed, a software engineer at <InlineCode>IMARAT</InlineCode>, where I craft intuitive
